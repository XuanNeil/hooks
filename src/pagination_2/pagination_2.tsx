...
export const Pagination2: React.FC<IPaginationProps> = ({currentPage, totalPage, onChange = () => {}}): JSX.Element => {

    const [page, setPage] = useState<number>(currentPage);

    const paging = useMemo(() => makeArrayPagination(totalPage, currentPage), [totalPage, currentPage]);
